...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		SemanticEmbeddingModel:      getString(k, "lab.semantic.embedding.model", "bge-m3"),
		SemanticEmbeddingDimensions: getInt(k, "lab.semantic.embedding.dimensions", 1024),
		SemanticChunkMaxChars:       getInt(k, "lab.semantic.chunk.max.chars", 2400),
		SemanticChunkOverlapChars:   getInt(k, "lab.semantic.chunk.overlap.chars", 300),
